...
export const Timeline = ({ data }) => {
  ...
  return (
    <div className="c-space secion-spacing" ref={containerRef}>
        ...
        {data.map((item, index) => (
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              <div
                className="h-10 absolute w-10 rounded-full bg-midnight
                flex items-center justify-center -left-[15px"
              >
            ...
            <div className="relative pl-20 pr-4 md:pl-4 w-full">
              ...
              {item.contents.map((content, idx) => (
                <p key={idx} className="mb-3 font-normal text-neutral-400">
                  {content}
                </p>
              ))}
            </div>
          ...
          className="absolute md:left-1 left-1 top-0 overflow-hidden
           w-[2px] bg-[linear-gradient(to_bottom,var(--tw-gradient-stops))]
            ...
            to-transparent to-[99%] 
             [mask-image:linear-gradient(to_bottom,transparent_0%,
        ...
        >
          <motion.div
            ...
            className="absolute inset-x-0 top-0  w-[2px] bg-gradient-to-t
             from-purple-500 via-lavender/50 to-transparent from-[0%] 
             via-[10%] rounded-full"
          />
        </div>
      </div>
